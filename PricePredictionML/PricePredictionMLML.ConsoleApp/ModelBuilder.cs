...
namespace PricePredictionMLML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\Armanya Dalmia\source\repos\MLTestPrograms\PricePredictionML\RegressionPricePrediction.tsv";
        private static string MODEL_FILEPATH = @"../../../../PricePredictionMLML.Model/MLModel.zip";
